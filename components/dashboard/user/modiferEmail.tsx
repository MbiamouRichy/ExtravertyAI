...
export default function ChangeEmailForm({
  ...
  const handleVerifyPassword = async (
    data: z.infer<typeof formPasswordSchema>,
  ) => {
  ...
  return (
    <Dialog open={open} onOpenChange={handleOpenChange}>
      ...
      <DialogContent className="sm:max-w-106.25">
          ...
          <form onSubmit={formPassword.handleSubmit(handleVerifyPassword)}>
            <DialogHeader>
              ...
              <DialogDescription>
                ...
                passe actuel avant de modifier votre email.
              </DialogDescription>
            </DialogHeader>
              ...
              <Controller
                ...
                render={({ field, fieldState }) => (
                  <Field data-invalid={fieldState.invalid}>
                    ...
                    <FieldDescription>
                      Entrez votre mot de passe actuel pour confirmer votre
                      identité avant de modifier votre adresse e-mail.
                    </FieldDescription>
                    {fieldState.invalid && (
        ...
        {step === 2 && (
          <form id="form-rhf-demo" onSubmit={formEmail.handleSubmit(onSubmit)}>
            <DialogHeader>
              <DialogTitle className="flex items-center gap-2">
        ...
        {step === 3 && (
          <div className="flex flex-col items-center justify-center py-6 text-center space-y-4">
            ...
            <DialogDescription className="text-base">
              ...
              . Cliquez sur le lien pour confirmer le changement. <br />
              <br />
              <span className="p-4 bg-muted rounded-lg inline-flex border-l-4 border-foreground leading-relaxed text-sm text-muted-foreground">
                Un email de sécurité a également été envoyé à votre ancienne
                adresse pour vous informer du changement.
              </span>
            </DialogDescription>
