...
import { Item, ItemContent, ItemDescription,  ItemFooter,  ItemMedia, ItemTitle } from "./ui/item";
import {  CheckCheck, LinkIcon, MessageCircleMoreIcon, MessageSquareTextIcon, SparklesIcon, TrendingUpIcon, UsersIcon, ZapIcon } from "lucide-react";
...
export default function HeroImage() {
  ...
  export const WhatsAppIcon = (props: React.ComponentProps<"svg">) => (
    <svg xmlns="http://www.w3.org/2000/svg" {...props} viewBox="0 0 16 16" fill="currentColor">
