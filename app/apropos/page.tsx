                ...
                <div className="w-full max-w-5xl md:mx-auto space-y-16 py-12 px-4 md:px-6">
                    ...
                    <section className="flex flex-col gap-6">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-4">
                            ...
                            <div className="flex flex-col p-6 rounded-xl border border-primary/20 bg-primary/5 dark:bg-card text-card-foreground shadow-sm transition-all hover:shadow-md relative overflow-hidden">
                        ...
                        <div className="p-4 mt-2 bg-muted/50 rounded-lg border-l-4 border-foreground">
